...
namespace arcane {
	...
	SpotLight::SpotLight(float lightIntensity, glm::vec3 &lightColour, glm::vec3 &pos, glm::vec3 &dir, float cutOffAngle, float outerCutOffAngle)
		: Light(lightIntensity, lightColour), m_Position(pos), m_Direction(dir), m_CutOff(cutOffAngle), m_OuterCutOff(outerCutOffAngle) {}
