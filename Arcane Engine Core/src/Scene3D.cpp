...
namespace arcane {
	...
	void Scene3D::init() {
		...
		//Add(new graphics::Renderable3D(glm::vec3(30.0f, -10.0f, 30.0if), glm::vec3(0.2f, 0.2f, 0.2f), glm::vec3(0.0f, 1.0f, 0.0f), 0, new arcane::graphics::Model("res/3D_Models/Overwatch/Reaper/Reaper.obj"), nullptr, true));
