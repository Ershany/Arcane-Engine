...
namespace arcane {
	...
	void Scene3D::init() {
		...
		add(new graphics::Renderable3D(glm::vec3(200.0f, 100.0f, 100.0f), glm::vec3(0.05f, 0.05f, 0.05f), glm::vec3(0.0f, 0.0f, 1.0f), glm::radians(0.0f), new arcane::graphics::Model("res/3D_Models/Sponza/sponza.obj"), nullptr, false));
