...
namespace arcane {
	...
	void Scene3D::init() {
		...
		m_RenderableModels.push_back(new RenderableModel(glm::vec3(70.0f, 75.0f, 120.0f), glm::vec3(5.0f, 5.0f, 5.0f), glm::vec3(0.0f, 1.0f, 0.0f), glm::radians(180.0f), hyruleShield, nullptr, true, false));
		...
		Model *sphere = new Model("res/3D_Models/Sphere/globe-sphere.obj");
		m_RenderableModels.push_back(new RenderableModel(glm::vec3(95.5f, 75.0f, 120.0f), glm::vec3(10.0f, 10.0f, 10.0f), glm::vec3(1.0f, 1.0f, 0.0f), 0.0f, sphere, nullptr, false, false));
		sphere->getMeshes()[0].getMaterial().setAlbedoMap(TextureLoader::getWhiteTexture());
		sphere->getMeshes()[0].getMaterial().setMetallicMap(TextureLoader::getWhiteTexture());
		sphere->getMeshes()[0].getMaterial().setRoughnessMap(TextureLoader::getBlackTexture());
