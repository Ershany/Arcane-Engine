...
namespace arcane { namespace utils {
	...
	public:
		...
		static graphics::Texture* load2DTexture(std::string &path, bool isSRGB);
		static graphics::Cubemap* loadCubemapTexture(const std::string &right, const std::string &left, const std::string &top, const std::string &bottom, const std::string &back, const std::string &front, bool isSRGB);
